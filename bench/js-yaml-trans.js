...
(function (global, factory) {
  ...
  function compileMap(/* lists... */) {
    ...
    result.mapping = {};
    result.fallback = {};
    result.multi = { scalar: [], sequence: [], mapping: [], fallback: [] };
  ...
  /*eslint-disable no-use-before-define*/ loader.loadAll = loadAll_1;
  loader.load = load_1;
  ...
  src.Type = Type;
  src.Schema = Schema;
  src.FAILSAFE_SCHEMA = FAILSAFE_SCHEMA;
  src.JSON_SCHEMA = JSON_SCHEMA;
  src.CORE_SCHEMA = CORE_SCHEMA;
  src.DEFAULT_SCHEMA = DEFAULT_SCHEMA;
  src.load = load;
  src.loadAll = loadAll;
  src.dump = dump;
  src.YAMLException = YAMLException;
  src.types = types;
  src.safeLoad = safeLoad;
  src.safeLoadAll = safeLoadAll;
  src.safeDump = safeDump;
